/**
 * Renderer.js - Moteur de rendu du jeu
 */
...
class Renderer {
    ...
    /**
     * Dessine l'arrière-plan (océan)
     */
    drawBackground(mapWidth, mapHeight) {
        const screenPos = this.worldToScreen(0, 0);
        const screenSize = {
            w: mapWidth * this.camera.zoom,
            h: mapHeight * this.camera.zoom
        };
        ...
        // Grille pour donner un effet d'eau
    ...
    /**
     * Dessine une entité (joueur ou bot)
     */
    drawEntity(entity) {
